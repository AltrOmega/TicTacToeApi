...
public class GameService {
     ...
     * @throws WrongFieldNameException if the values for "mark" or "pos" are invalid or incorrect
     * @throws GameStateWonException if the game has already ended
     * @throws GameStateOutOfTurnException if the player tries to place a mark out of turn
     */
    public Game placeInGame(Integer gameId, ObjectNode objectNode){
        ...
        if (misplaceOp.isPresent()) {
            ...
            if (misplace == Misplace.OUT_OF_TURN) {
                throw new GameStateOutOfTurnException("Can't place the mark of: \"" + mark +"\" now. Its not your turn.");
            }
    ...
    /**
     * Overwrites the game data with a new game instance.
     *
     * @param gameId the ID of the game to overwrite
    ...
    /**
     * Converts a Game domain object to a GameEntity for persistence.
     *
     * @param game the Game domain object
     * @return the GameEntity instance
     */
    ...
    /**
     * Converts a Game domain object to a GameEntity for persistence with an existing game ID.
     *
    ...
    /**
     * Converts a GameEntity to a Game domain object.
     *
     * @param gameEntity the GameEntity instance to convert
